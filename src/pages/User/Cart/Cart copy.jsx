...
import { deleteCartItem, getUserCart, selectCartItem, selectCartRes } from "../../../redux/cart/cartSlice";
...
const Cart = () => {
  ...
  // Hàm tính tổng giá sản phẩm đã chọn
  ...
  return (
    <div className="container d-flex">
      ...
      <div className="action-cart col-3 px-4">
        {/* <div className="amount-cart">Tổng: { calculateTotalPrice() }</div>
        <button className="btn btn-primary mt-4" onClick={ () => navigate( '/checkout' ) }>Mua hàng</button> */}
      </div>
    </div>
  )
}
